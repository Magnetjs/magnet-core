...
classes.setupThrowError = class Test extends Base {
  async setup () {
    throw new Error('Throw error')
  }
}
classes.teardownThrowError = class Test extends Base {
  async setup () {}
