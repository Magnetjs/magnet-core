...
- DI support with https://github.com/jeffijoe/awilix
- Function based module structure
- [Draft](https://github.com/Magnetjs/magnet-core/blob/master/docs/v5-design)

## v6

- Support serverless
- Auto update `config/*.js` when extra field introduced
